...
try:
    # DEPRECATED: compatibility for dj22
...
def set_theme(request):
    """
    Redirect to a given url while setting the chosen theme in the session or
    cookie. The url and the theme identifier need to be specified in the request
    parameters.
